...
program
  ...
  // .option(
  //   "-vt,    --validationTime <validationTime>",
  //   "The time it takes to validate the UI element",
  // )
  // .option(
  //   "-vty,   --validationType <validationType>",
  //   'The type of validation for the UI element (default is "none")',
  // )
  // .option(
  //   "-ci,    --criticalInformation",
  //   "Whether the UI element contains critical information",
  // )
  // .option(
  //   "-atf,   --averageTimeToFill <averageTimeToFill>",
  //   "The average time to fill the UI element",
  // )
  // .option(
  //   "-atc,   --averageTimeToCorrect <averageTimeToCorrect>",
  //   "The average time to correct the UI element",
  // )
  ...
  .option(
    "-t,     --tags <tags>",
    "Tags of the UI element, separated by commas",
  )
  .option(
    "-g,     --group <group>",
